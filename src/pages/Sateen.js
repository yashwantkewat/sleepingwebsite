...
const Sateen = () => {
    ...
    const handleImageClickbyEight = (id) => {
        navigate(`/eight-thread-count/${id}`);
    };
    const handleImageClickbysix = (id) => {
        navigate(`/six-thread-count/${id}`);
    };
    ...
    return (
        <>
            ...
            <div className='pt-20'>
                ...
                {/* section 800 threads  */}
                <div className="p-15 bg-red-50 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="rounded shadow p-6 text-left flex flex-col justify-center">
                        <h2 className="text-xl font-bold mb-2">Classic Comfort Collection</h2>
                        <p className="text-base text-gray-800">800 Thread Count</p>
                        <p className="text-sm text-gray-700 max-w-xl">
                            Indulge in the pinnacle of luxury with our 100% cotton sheet collection.
                        </p>
                    </div>
                    ...
                    {sheetSets.map(product => (
                        <div key={product.id} className="group relative  rounded overflow-hidden shadow hover:shadow-lg transition">
                            <img
                                onClick={() => handleImageClickbyEight(product.id)}
                                src={product.image}
                                alt={product.name}
                                className="w-full h-72 object-cover group-hover:scale-105 transition-transform duration-300"
                            />
                ...
                <div className="p-15  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    <div className="rounded shadow p-6 text-left flex flex-col justify-center">
                        <h2 className="text-xl font-bold mb-2">On the Road RV Collection</h2>
                        <p className="text-base text-gray-800">600 Thread Count</p>
                        <p className="text-sm text-gray-700 max-w-xl">
                            Indulge in the pinnacle of luxury with our 100% cotton sheet collection.
                        </p>
                    </div>
                    ...
                    {sheetSets.map(product => (
                        <div key={product.id} className="group relative  rounded overflow-hidden shadow hover:shadow-lg transition">
                            <img
                                onClick={() => handleImageClickbysix(product.id)}
                                src={product.image}
                                alt={product.name}
                                className="w-full h-72 object-cover group-hover:scale-105 transition-transform duration-300"
                            />
