...
const Home = () => {
    ...
    const eighthundred = [
        {
            id: 1,
            name: "800 TC Royal Cotton Set",
            image: "https://images.playground.com/17c663d5-e3d6-4f22-b4e3-753bfbf34366.jpeg",
            basePrice: 120,
            discount: 20,
            inStock: true,
            description: "Experience true hotel-luxury comfort with our 1000 thread count premium cotton sheet set.",
            ...
            <div className='pt-20'>
                ...
                <div className="p-15  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className=" rounded shadow p-6 text-left flex flex-col items-center justify-center">
                        <h2 className="text-xl  font-bold mb-2">The Bamboo Collection</h2>
                        <p className="text-sm text-gray-700 max-w-xl">
