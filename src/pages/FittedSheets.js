  ...
  const fittedSheets = [
    {
      ...
      discount: 10,
      inStock: true,
      description: "Soft and breathable deep-pocket fitted sheet for extra comfort and perfect fit.",
     colors: [
    ...
    {
      id: 2,
      name: "Luxury Fitted Sheet",
      image: "https://images.playground.com/d7078128-b1cf-4396-a433-d353fddf15f9.jpeg",
      basePrice: 75,
      discount: 20,
      inStock: true,
      description: "Luxury cotton fitted sheet for hotel-quality sleep at home.",
     colors: [
        { code: "#991b1b", name: "Red", price: 0 },
        { code: "#d6d3d1", name: "Stone", price: 10 },
        { code: "#fef2f2", name: "Cream", price: 5 },
    ...
    
    {
      ...
      image: "https://images.playground.com/5d97a63a-1191-443d-a595-3edc340817eb.jpeg",
      basePrice: 75,
      discount: 20,
      inStock: true,
      description: "Premium cotton fitted sheet for hotel-quality sleep at home.",
     colors: [
        { code: "#991b1b", name: "Red", price: 0 },
        { code: "#d6d3d1", name: "Stone", price: 10 },
        { code: "#fef2f2", name: "Cream", price: 5 },
      ...
      <div className='pt-20'>
        ...
        <div className="p-15 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          <div className="rounded shadow p-6 text-left flex flex-col items-center justify-center">
            <h2 className="text-xl font-bold mb-2">Premium Fitted Sheets</h2>
            <p className="text-sm text-gray-700 max-w-xl">
              Explore our collection of fitted sheets crafted for comfort, fit, and elegance.
              Available in various sizes and soothing colors.
            </p>
          </div>

          {fittedSheets.map(product => (
