...
const FittedSheetProduct = () => {
  ...
  const fittedSheetProducts = [
    {
      ...
      image: "https://images.playground.com/1607f89b-945a-423c-8b1a-55082e37d31d.jpeg",
      images: [
        "https://images.playground.com/d7078128-b1cf-4396-a433-d353fddf15f9.jpeg",
        "https://images.playground.com/1607f89b-945a-423c-8b1a-55082e37d31d.jpeg",
        "https://images.playground.com/eceac144-1926-4903-a0d9-3fc63d66476b.jpeg",
        "https://images.playground.com/7c55f1ed-e5d2-473e-a855-70b5355f5c82.jpeg"
      ...
      discount: 30,
      inStock: true,
      subtitle: "16\" Deep Pockets, Ultra Soft Microfiber",
      description: "Our Deep Pocket Fitted Sheet stays securely in place and offers silky smooth comfort. Designed to fit extra thick mattresses with ease and style.",
      colors: [
  ...
  useEffect(() => {
    ...
    if (!existing) {
      localStorage.setItem('products', JSON.stringify(fittedSheetProducts));
    }
  }, []);
  ...
  if (!product)
    return (
      <div className="min-h-screen flex items-center justify-center">
        <h2 className="text-2xl text-gray-600">Fitted Sheet not found</h2>
      </div>
    );
    ...
    <>
      ...
      <section className="max-w-7xl bg-red-200 mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-2">Secure Fit</h3>
            <p className="text-gray-600 text-sm">Extra deep pockets and elastic edges to keep your sheet snug and in place.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2">Wrinkle Resistant</h3>
            <p className="text-gray-600 text-sm">No ironing needed — wake up to a fresh look every day.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2">Soft & Durable</h3>
            <p className="text-gray-600 text-sm">Built to last and feel soft even after dozens of washes.</p>
          </div>
          <div>
            <h3 className="text-lg font-semibold mb-2">Eco-Friendly</h3>
            <p className="text-gray-600 text-sm">Made from sustainable microfiber that conserves water & energy.</p>
          </div>
        </div>
      </section>
    </>
...
export default FittedSheetProduct;
